...
class SipdRkpdSubKegiatan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $schema='rkpd.';
         ...
         if(!Schema::connection('pgsql')->hasTable($schema.env('TAHUN').'_sub_kegiatan')){
              Schema::connection('pgsql')->create($schema.env('TAHUN').'_sub_kegiatan',function(Blueprint $table) use ($schema){
    ...
    public function down()
    {
        ...
        Schema::connection('pgsql')->dropIfExists($schema.env('TAHUN').'_sub_kegiatan');
    }
}
